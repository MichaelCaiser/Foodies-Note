...
//3rd part code
static NSString * const kConsumerKey       = @"H72rPdMK5UyksWEEuIzFmw";
static NSString * const kConsumerSecret    = @"MriNvkPyrK-I7g1myO_MvUAm54c";
static NSString * const kToken             = @"euHNSh-R34wHi8d7o_mvQDGGLbDetbLA";
static NSString * const kTokenSecret       = @"noLPdJM1Vm-nuiyX3oZHWgOw1xk";
